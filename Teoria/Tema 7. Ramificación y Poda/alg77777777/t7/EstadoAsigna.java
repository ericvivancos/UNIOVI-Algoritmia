...
/**
 * Estado Asignación Agentes - Tareas
...
public class EstadoAsigna extends Estado 
{
	...
	private static int n;				// Tamaño del problema, núm. agentes y núm. tareas
	...
	public EstadoAsigna() {
		...
		n= 4;		// número de agentes y tareas
		// matriz de costes
		costes = new int[n][n];
	...
	public void calcularValorHeuristico() {
		...
		// Suma los mínimos de lo que resta de columna por cada tarea no asignada
		for (int j = 0; j<n; j++)
	...
	/**
	 * Calcula el valor mínimo por columnas
