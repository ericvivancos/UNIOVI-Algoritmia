...
{	
	...
	static int metodo; // dos heurísticos implementados


	public static void main(String[] arg) 
	/* Los argumentos de ejecución son       :  inicio  metodo
...
/* Concretar la clase Nodo en el Problema 2 (Puzzle) */
{
	...
	/* Heuristico 1: número de fichas en posición incorrecta */
	{
		int incorrecto = 0;
		for (int i=0; i<9; i++)
			if (tablero[i] != (i+1))
	...
	/* Heuristico 2: distancia Manhattan: suma para todas las
   		fichas de las distancias entre la posición actual y 
   		la posición  final  */   
	{
		int manhattan = 0;
		int x1, x2, y1, y2;
	...
	/* Si no se puede alcanzar la solución devuelve true
   ...
   j<i and position(j)>position(i) */
	...
	/* posición en el estado inicial de ficha número i */
